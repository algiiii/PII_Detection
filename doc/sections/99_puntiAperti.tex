...
\begin{itemize}
	...
	\item \textbf{TB-2} — Architettura: diagramma ER in TikZ del modello di persistenza (\texttt{PIIInstance}, \texttt{PIIChange}, \texttt{Document}, \texttt{Scan}, \texttt{ProcessingActivity}), da produrre dopo la chiusura di PA-6/7/8 (cfr.~§\ref{sub:persistenza-modello-dati}).
